...
static NSString * const CitysCellID = @"CitysCell";
...
-(void)createUI
{
    ...
    [collectionView registerNib:[UINib nibWithNibName:@"CitysCell" bundle:nil]
     forCellWithReuseIdentifier:CitysCellID];
...
- (__kindof UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    CitysCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:CitysCellID forIndexPath:indexPath];
...
-(void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    //    }
    CitysCell *cell = (CitysCell *)[self.collectionView cellForItemAtIndexPath:indexPath];
    //       MsgCell  *selectCell = [self.msgTableView cellForRowAtIndexPath:indexPath]；
    NSLog(@"%@",self.dataArr[indexPath.row]);
    if ([self.delegate respondsToSelector:@selector(cityViewClickItemCell:clickItemIndexPath:ClickTitle:)]) {
        [self.delegate cityViewClickItemCell:cell clickItemIndexPath:indexPath ClickTitle:self.dataArr[indexPath.row]];
    }
}
